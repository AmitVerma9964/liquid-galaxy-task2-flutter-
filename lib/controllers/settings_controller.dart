...
class SettingsController {
  ...
  Future<Map<String, dynamic>> loadSettings() async {
    ...
    _lgHost = prefs.getString(_hostKey) ?? defaultHost;
    _lgPort = prefs.getInt(_portKey) ?? defaultPort;
    _lgUsername = prefs.getString(_usernameKey) ?? defaultUsername;
    _lgPassword = prefs.getString(_passwordKey) ?? defaultPassword;
    _lgRigsNum = prefs.getInt(_rigsNumKey) ?? defaultRigsNum;
  ...
  Future<void> clearSettings() async {
    ...
    await prefs.remove(_rigsNumKey);
  }
}
